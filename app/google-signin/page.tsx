  ...
  return (
    <div className={cn("flex flex-col gap-6 w-full max-w-md mx-auto", className)} {...props}>
            ...
            <FieldGroup className="space-y-4">
              ...
              <Field className="grid grid-cols-3 gap-4">
                <Button 
                  variant="outline" 
                  type="button" 
                  className="bg-white hover:bg-gray-50 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all h-12"
                >
              ...
              <FieldDescription className="text-center text-black font-medium mt-4">
                Don&apos;t have an account? <a href="#" className="text-[#006B6B] hover:underline font-bold">Sign up</a>
              </FieldDescription>
            </FieldGroup>
          </form>
        </CardContent>
      ...
      <FieldDescription className="px-6 text-center text-black/70">
        By clicking continue, you agree to our <a href="#" className="hover:underline text-black">Terms of Service</a>{" "}
        and <a href="#" className="hover:underline text-black">Privacy Policy</a>.
      </FieldDescription>
