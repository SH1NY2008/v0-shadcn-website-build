    ...
    units: [
      {
        ...
        topics: [
          { name: "Variables and expressions", videoId: "vDqOoI-4Z6M" },
          { name: "Order of operations", videoId: "SWRCjspjJko" },
          { name: "Evaluating expressions", videoId: "X2jz0OgOjdg" },
          { name: "Properties of numbers (commutative, associative, distributive)", videoId: "mgw2JfwtT5E" },
        ],
      },
      {
        name: "Unit 2: Solving Equations and Inequalities",
        topics: [
          { name: "One-step and two-step equations", videoId: "TxqBn43hijY" },
          { name: "Multi-step equations", videoId: "YpLSZdhOhtU" },
          { name: "Solving inequalities", videoId: "DrZJKdXlZ3I" },
          { name: "Absolute value equations and inequalities", videoId: "oBmtAntH340" },
        ],
      },
      {
        name: "Unit 3: Functions and Relations",
        topics: [
          { name: "Definition of a function", videoId: "DYRVQ2houJE" },
          { name: "Domain and range", videoId: "KirGQOwjBVI" },
          { name: "Function notation", videoId: "Kj3Aqov52TY" },
          { name: "Linear vs. nonlinear functions", videoId: "Pt-Tn6L60-o" },
        ],
      },
      {
        name: "Unit 4: Linear Functions",
        topics: [
          { name: "Slope and rate of change", videoId: "Iqws-qzyZwc" },
          { name: "Graphing linear equations", videoId: "NAblGVxxJZo" },
          { name: "Writing equations of lines", videoId: "ri1bagtR08A" },
          { name: "Parallel and perpendicular lines", videoId: "V0xounKGEXs" },
        ],
      },
      {
        name: "Unit 5: Systems of Equations and Inequalities",
        topics: [
          { name: "Solving systems by graphing, substitution, and elimination", videoId: "_cSSFLsiNJ8" },
          { name: "Applications of systems", videoId: "S4HhgvcLwb0" },
          { name: "Systems of inequalities and graphing solutions", videoId: "FWbcKade3rw" },
        ],
      },
      {
        name: "Unit 6: Polynomials and Factoring",
        topics: [
          { name: "Adding, subtracting, multiplying polynomials", videoId: "hM_qIhR5jIc" },
          { name: "Special products (square of a binomial, difference of squares)", videoId: "HV4UAhbLdmk" },
          { name: "Factoring trinomials and grouping", videoId: "HvBiJ9W00Z4" },
        ],
      },
      {
        ...
        topics: [
          ...
          { name: "Solving quadratics (factoring, completing the square, formula)", videoId: "qeByhTF8WEw" },
          { name: "Discriminant and nature of roots", videoId: "IF37dBhF1YY" },
        ],
      },
      {
        ...
        topics: [
          ...
          { name: "Simplifying radicals and rationalizing denominators", videoId: "2UyldZ5yz84" },
          { name: "Solving radical equations", videoId: "0gicD4STzpg" },
        ],
      },
      {
        ...
        topics: [
          ...
          { name: "Box plots and interpreting data", videoId: "nV8jR8M8C74" },
        ],
      },
    ],
  },
    ...
    units: [
      {
        ...
        topics: [
          { name: "Points, lines, planes, and angles", videoId: "dDWjhRfBsKM" },
          { name: "Angle relationships (complementary, supplementary, vertical)", videoId: "eMReka2Kxkk" },
          { name: "Constructions with compass and straightedge", videoId: "IrRTGbqr8MQ" },
        ],
      },
      {
        name: "Unit 2: Logic and Proof",
        topics: [
          { name: "Conditional statements and converses", videoId: "afAt0jEF74c" },
          { name: "Postulates and theorems", videoId: "boec54z0VW4" },
          { name: "Two-column proofs and paragraph proofs", videoId: "4mp9-O2G8hE" },
        ],
      },
      {
        name: "Unit 3: Parallel and Perpendicular Lines",
        topics: [
          { name: "Transversals and angle relationships", videoId: "5PcMbN46NMA" },
          { name: "Proving lines parallel or perpendicular", videoId: "wi_ykoUX2nw" },
          { name: "Slopes of parallel and perpendicular lines", videoId: "JtWhopJ8-7A" },
        ],
      },
      {
        name: "Unit 4: Triangles",
        topics: [
          { name: "Triangle angle sum and exterior angle theorem", videoId: "PsJLmx8N0-c" },
          { name: "Congruence criteria (SSS, SAS, ASA, AAS, HL)", videoId: "PAF0V3d2qTY" },
          { name: "Properties of isosceles and equilateral triangles", videoId: "XbLNa6rAYRc" },
          { name: "Triangle inequalities", videoId: "oNR7wtdJhYk" },
        ],
      },
      {
        ...
        topics: [
          ...
          { name: "Properties of quadrilaterals (parallelograms, rectangles, rhombuses, squares, trapezoids)", videoId: "WxqNG1E_pi8" },
          { name: "Coordinate geometry of quadrilaterals", videoId: "qygBbB81zAw" },
        ],
      },
      {
        name: "Unit 6: Similarity",
        topics: [
          { name: "Ratios, proportions, and similarity", videoId: "A9sEcC4BGEE" },
          { name: "Similar triangles and AA, SAS, SSS similarity", videoId: "efNsMjrVWgc" },
          { name: "Side splitter and triangle proportionality theorems", videoId: "EQpguitDfGU" },
        ],
      },
      {
        name: "Unit 7: Right Triangles and Trigonometry",
        topics: [
          { name: "Pythagorean theorem and its converse", videoId: "J5IP-OPG8Ck" },
          { name: "Special right triangles (30-60-90, 45-45-90)", videoId: "Y_qs4cgxbgs" },
          { name: "Basic trigonometric ratios (sine, cosine, tangent)", videoId: "PUB0TaZ7bhA" },
        ],
      },
      {
        name: "Unit 8: Circles",
